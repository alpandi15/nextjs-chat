...
export const Content = styled.div`
  ...
  overflow: hidden;
`
export const LeftSide = styled.div<MobileSideProps>`
  width: 30%;
  
  @media only screen and ${device?.mobileS} {
    display: ${props => !props.mobileVisible ? 'none' : ''};
    width: 100%;
  }
`
export const RightSide = styled.div<MobileSideProps>`
  width: 70%;
...
export const ActionContent = styled.div<MobileSideProps>`
  ...
  align-items: center;
  @media only screen and ${device?.mobileS} {
    display: ${props => !props.mobileVisible ? 'flex' : ''};
  }
`
